...
.divTableHead {
  ...
  <body>
    ...
    <table class="header">
        <tr>
            <td><h4>No. Requisici&oacute;n: </h4></td>
            <td><h4>{{$numberRequisition}}</h4></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
