...
role="dialog" tabindex="-1" id="modal-delete-{{$assigmentOption->idAssignmentOption}}">
		{{Form::Open(array('action'=>array('secAssignmentOptionController@destroy',$assigmentOption->idAssignmentOption), 'method'=>'delete'))}}	
