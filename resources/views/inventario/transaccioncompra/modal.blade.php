...
role="dialog" tabindex="-1" id="modal-delete-{{$tran->idtransaccion}}">
		{{Form::Open(array('action'=>array('transaccioncompraController@destroy',$tran->idtransaccion), 'method'=>'delete'))}}	
