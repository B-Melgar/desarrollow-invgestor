...
<div class="row">
	<div class = "col-lg-8 col-md-8 col-sm-8 col-xs-12 titlecatalogos">
		<h2>Compras: </h2> <a href="transaccioncompra/create"><button class="btn btn-primary"><i class="fa fa-plus"></i> Agregar</button> </a> <h4></h4>
		@include ('inventario.transaccioncompra.search')
	</div>
</div>
		...
		<div class="">	
			<table class ="table table-striped table-bordered table-condensed table-hover">
				...
				<tr>
					...
					<td class="table-active">{{$tran->nombreproveedor}}</td>
					...
					<td class="table-active alignButtonGrid">
						<!-- <a href="{{URL::action('transaccioncompraController@edit', $tran->idtransaccion)}}"><button class="btn btn-outline-primary"><i class="fa fa-pencil"></i></button></a> -->
					...
					<td>
						<a href="../listadetalletransaccioncompra/{{$tran->idtransaccion}}"><button class="btn btn-outline-primary"><i class="fa fa-eye"></i></button></a>
					</td>
				</tr>
