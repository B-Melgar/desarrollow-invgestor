...
role="dialog" tabindex="-1" id="modal-deletedetalle-{{$detalle->iddetalletransaccion}}">
		{{Form::Open(array('action'=>array('transacciondetallecompraController@destroy',$detalle->iddetalletransaccion), 'method'=>'delete'))}}	
