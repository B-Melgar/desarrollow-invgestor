...
role="dialog" tabindex="-1" id="modal-delete-{{$ordcompra->idordencompra}}">
		{{Form::Open(array('action'=>array('transaccioncompraController@destroy',$ordcompra->idordencompra), 'method'=>'delete'))}}	
