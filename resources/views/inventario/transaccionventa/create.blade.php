...
<script type="text/javascript">
	...
	{!! Form::open(array('url' => 'inventario/transaccionventa', 'method' => 'POST', 'autocomplete'=>'off', 'files'=>'true')) !!}
	{{Form::token()}}
	@csrf
...
<div class="">			
	...
	<div class="form-group col-md-12">
		<a href="{{url ('inventario/transaccionventa')}}" class="btn btn-danger"><i class="fa fa-ban"></i> Cancelar</a>
