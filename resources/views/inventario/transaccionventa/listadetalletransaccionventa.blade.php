...
<script type="text/javascript">
	document.addEventListener('DOMContentLoad', function(){	
		...
		var url = "../listadetalletransaccionventa/" + strtransaccion;
	...
	document.addEventListener('DOMContentLoaded', function(){
		...
		$("#btnAgregarProducto").click(function(){
			...
			if(strproducto > 0 && strcantidad > 0){
				//var subtotal = strcantidad * strprecio;
                $.ajax({
                    url: '/postdetalleventa',
                    type: 'POST',
                    data: {_token: CSRF_TOKEN, idtransaccion:strtransaccion, idproducto:strproducto, cantidad:strcantidad},
                    dataType: 'JSON',
...
<div class="" style="text-align: lefth; width=300">
	<table>
		<tr>
			<td>
				<a href="../inventario/transaccionventa"><button id="regresarTransaccion" class= "btn btn-secondary text-light" title="Regresar">Regresar</button></a>
			</td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td>
				@if(($idestadotransaccion) == 1)
