...
<script type="text/javascript">
	...
	{!! Form::open(array('url' => 'inventario/transacciondetallecompra', 'method' => 'POST', 'autocomplete'=>'off')) !!}
	{{Form::token()}}
	@csrf
...
<div class="">			
	<div class="form-group col-md-12">
		...
		<table>
			<tr>
				<td>
					<div class="labelDetalles">PRODUCTO</div>
				</td>
				<td>
				</td>
				<td>
			...
			<div class="form-group col-md-12">
				<a href="{{url ('inventario/cliente')}}" class="btn btn-danger"><i class="fa fa-ban"></i> Cancelar</a>
